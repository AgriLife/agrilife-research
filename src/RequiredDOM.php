...
class RequiredDOM {
    ...
    public function logo_title( $title, $inside, $wrap ) {
        ...
        if($agency == 'research' || (is_array($agency) && in_array('research', $agency))){
            $logos = sprintf( '<a href="%s" class="%s-logo" title="%s"><span>%s</span></a>', 'http://agriliferesearch.tamu.edu/', 'research-extension', 'Research and Research', 'Research and Research' );
        }
    ...
    /**
     * Add research info to bottom of page
     * @since 1.0
     * @return void
     */
    public function add_research_footer_content()
    {
        remove_all_actions('genesis_footer');
        add_action( 'genesis_footer', 'genesis_footer_markup_open', 5 );
        add_action( 'genesis_footer', 'genesis_footer_markup_close', 15 );

        add_action('genesis_footer', array($this, 'render_research_logo'));
    ...
    /**
     * Render Research logo
     * @since 1.0
     * @return string
     */
    public function render_research_logo()
    {
    ...
    public static function render_tamus_logo()
    {
        ...
        $output = '
            <div class="footer-container-tamus">
                <a href="http://tamus.edu/" title="Texas A&amp;M University System"><img class="footer-tamus" src="'.AG_RESEARCH_DIR_URL.'/img/logo-tamus.png" title="Texas A&amp;M University System Member" alt="Texas A&amp;M University System Member" />
